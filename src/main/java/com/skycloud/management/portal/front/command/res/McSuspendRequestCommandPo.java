...
public class McSuspendRequestCommandPo extends BaseCommandPo {

	private static final String COMMAND = "mcsuspendReq";
	
	public McSuspendRequestCommandPo (){
		 super(COMMAND);
	}
	/**
	...
	protected  QueryCommand fromJsonToOperatePo (String jsonStr){
		throw new ServiceException("McSuspendRequestCommandPo方法fromJsonToOperatePo不可用");
	}
}
