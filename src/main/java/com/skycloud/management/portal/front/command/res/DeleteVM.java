...
public class DeleteVM  extends BaseCommandPo {

	public static final String COMMAND = "DeleteVM";
	...
	protected  QueryCommand fromJsonToOperatePo (String jsonStr){
		try{
			...
			DeleteVM po = (DeleteVM)JsonUtil.getObject4JsonString(tempJson, DeleteVM.class);
			return po;
		}catch(Exception e){
