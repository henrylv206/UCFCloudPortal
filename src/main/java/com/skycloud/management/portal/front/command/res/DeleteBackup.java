...
public class DeleteBackup  extends BaseCommandPo {

	public static final String COMMAND = "DeleteBackup";
	...
	protected  QueryCommand fromJsonToOperatePo (String jsonStr){
		try{
			...
			DeleteBackup po = (DeleteBackup)JsonUtil.getObject4JsonString(tempJson, DeleteBackup.class);
			return po;
		}catch(Exception e){
