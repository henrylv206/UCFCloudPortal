...
public class McStopRequestCommandPo extends BaseCommandPo {

	private static final String COMMAND = "mcstopReq" ;
	
	public McStopRequestCommandPo (){
		super(COMMAND);
	}
	/**
	...
	protected  QueryCommand fromJsonToOperatePo (String jsonStr){
		throw new ServiceException("McStopRequestCommandPo方法fromJsonToOperatePo不可用");
	}
