...
public class TemplateCloudStoragePo {
	...
	public TemplateCloudStoragePo  (){
		
	}
	public static TemplateCloudStoragePo getIntance(TTemplateVMBO template){
		TemplateCloudStoragePo templateVdc = new TemplateCloudStoragePo ();
		templateVdc.setMeasureMode(template.getMeasureMode());
		templateVdc.setResourceType("CIDC-RT-OS");
...
//		}
	...
	public static String countTemplateId(){
		...
		try {
			...
			str = "CIDC-T-OTHER-"+strBuf.toString();
		} catch (Exception e) {
			e.printStackTrace();
		}
		return str;
	...
	public static String toString (TemplateCloudStoragePo po){
		XStream xstream = new XStream();
		xstream.alias("ObjectStoreTemplate",TemplateCloudStoragePo.class);
	...
	public static String getXmlTemplateId (String xml){
		...
		xstream.alias("ObjectStoreTemplate",TemplateCloudStoragePo.class);
		xstream.alias("ResourceInfo",BaseCloudStackResourceInfo.class);
		TemplateCloudStoragePo po = (TemplateCloudStoragePo)xstream.fromXML(xml);
