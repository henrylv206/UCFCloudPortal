 ...
 * @version 1.0 2002 March 27 1.1 2002 March 28 - allow variable separator - add
 *          close method 1.2 2002 April 23 - put in to separate package 1.3 2002
 *          April 24 - three levels of quoting 1.4 2002 April 24 - convenience
 *          constructor - put(null) now means nl. 1.6 2002 May 25 - allow choice
 *          of quote char 1.9 2002 November 14 - trim parameter to control
 *          whether fields are trimmed of lead/trail whitespace (blanks, Cr, Lf,
 *          Tab etc.) before writing.
 */
public class CSVWriter {
	 ...
	 * @param quoteLevel
	 *            0 = minimal quotes 1 = quotes also around fields containing
	 *            spaces 2 = quotels around all fields. whether or not they
	...
	public void put(String s) {
		...
		else if (quoteLevel == 2 || s.indexOf(separator) >= 0)// �ո񲻼�˫���
		{
	...
	public void nl() {
		...
		pw.print("\r\n"); /*
						 * windows conventions since this is a windows format
						 * file
						 */
